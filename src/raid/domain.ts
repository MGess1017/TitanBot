...
export const RAID_MAPS: Record<RaidMapKey, RaidMapConfig> = {
    ...
    obsidian_spire: {
        ...
        bossPool: [{ name: "Veyra the Blackglass Matriarch", title: "Spire Tyrant", ferocity: 2.12, successPenalty: 0.19, killPenalty: 0.23, raidPressure: 0.036, bonusXpRange: [360, 590], tokenRewardRange: [300, 520], weaponDrops: ["rail_sniper", "enhanced_rail_sniper", "eclipse_glaive"], armorDrops: ["titan_carapace", "eclipse_ward"], rareDropChance: 0.54 }],
        successWeapons: ["rail_sniper", "reactor_blade", "enhanced_rail_sniper", "enhanced_reactor_blade", "eclipse_glaive"], failureWeapons: ["plasma_carbine", "mythic_hammer", "rail_sniper", "reactor_blade"], successArmor: ["aegis_exosuit", "titan_carapace", "leviathan_shell", "eclipse_ward"], failureArmor: ["void_shield", "adaptive_mesh", "juggernaut_frame", "aegis_exosuit"], bossKit: { weaponId: "eclipse_glaive", armorId: "eclipse_ward" }, scrapBonus: 11, bonusLootPool: [{ id: "rail_barrel", weight: 6 }, { id: "plasma_focusing_lens", weight: 5 }, { id: "reactor_edge_core", weight: 3 }, { id: "black_ice_lens", weight: 3 }, { id: "mythic_crate", weight: 2 }], crateDropTable: [{ id: "tactical_crate", weight: 3 }, { id: "mythic_crate", weight: 4 }], bossCrateDropTable: [{ id: "mythic_crate", weight: 5 }, { id: "eclipse_blade_fragment", weight: 1 }]
    },
    nullforge_depths: {
    ...
    eclipse_bastion: {
        ...
        bossPool: [{ name: "Eclipse Praetor Nyx", title: "Black Sun General", ferocity: 2.52, successPenalty: 0.25, killPenalty: 0.3, raidPressure: 0.048, bonusXpRange: [600, 1040], tokenRewardRange: [540, 980], weaponDrops: ["eclipse_glaive", "chaos_staff", "enhanced_starforged_reaper"], armorDrops: ["eclipse_ward", "apocalypse_aegis"], rareDropChance: 0.72 }],
        successWeapons: ["eclipse_glaive", "enhanced_starforged_reaper", "chaos_staff", "reality_breaker"], failureWeapons: ["enhanced_rail_sniper", "enhanced_reactor_blade", "nullburst_launcher"], successArmor: ["eclipse_ward", "apocalypse_aegis", "chaos_mantle"], failureArmor: ["dreadnought_cuirass", "voidscale_regalia", "sovereign_bastion"], bossKit: { weaponId: "eclipse_glaive", armorId: "apocalypse_aegis" }, scrapBonus: 14, bonusLootPool: [{ id: "eclipse_blade_fragment", weight: 3 }, { id: "chaos_splinter", weight: 0.5 }, { id: "black_ice_lens", weight: 5 }, { id: "collector_eclipse_vault_deed", weight: 0.02 }], crateDropTable: [{ id: "tactical_crate", weight: 1 }, { id: "mythic_crate", weight: 6 }], bossCrateDropTable: [{ id: "mythic_crate", weight: 6 }, { id: "eclipse_blade_fragment", weight: 2 }, { id: "chaos_splinter", weight: 0.5 }]
    },
    titanfall_crucible: {
